...
func (n Logical) Accept(visitor ExprVisitor) interface{} {
    return visitor.VisitLogicalExpr(n)
}
...
func (n Assign) Accept(visitor ExprVisitor) interface{} {
    return visitor.VisitAssignExpr(n)
}
